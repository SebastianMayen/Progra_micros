...
inte_portb: ;interrupcion en el puertoB
    banksel PORTB
    btfss PORTB, 0 ;Si el bit 0 cambio, entonces se incrementa el portA
    incf PORTA
    btfss PORTB, 1	;Si el bit 1 cambio, entonces se decrementa el portA
    decf PORTA
    bcf RBIF
    return
...
set_cont:
    movlw 100 ;valor de los ciclos que tiene que realizar el tmr0 para que se incremente en 1 el contador de segundos.
